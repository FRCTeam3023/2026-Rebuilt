...
public class ControlPanel {
    ...
    public static void configureBinding(Drivetrain drivetrain, Shooter shooter, Intake intake, Indexer indexer) {
        ...
        */
        ...
        //new Trigger(() -> controller.getRawAxis(3) > 0.7).whileTrue(shooter.shootCommand(3500)); // RIGHT TRIGGER | Dumb Shoot Command
        
        new JoystickButton(controller, 2).whileTrue(shooter.shootCommand(3000));
        ...
        new Trigger(() -> controller.getRawAxis(3) > 0.5).whileTrue(indexer.setIndexVelocityCommand(2000)); // Right Trigger | Indexes into the shooter (SPIN UP SHOOTER FIRST)
