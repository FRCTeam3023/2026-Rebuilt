...
public class Constants {
    ...
    public static class HUB{
        public static double RED_OFFSET = -Units.inchesToMeters(23.51);
        public static double BLUE_OFFSET = Units.inchesToMeters(23.51);
        public static int RED_TAG = 10;
        public static int BLUE_TAG = 25;
        public static double HUB_TARGET_HEIGHT = 1.3716;
    }
